...
*
* Runs all four analysis parts sequentially. Each part produces its own
* clean log file (command echo stripped):
*
*   part1_outcomes_log.txt      -- One treatment x 10 outcomes
*   part2_treatments_log.txt    -- 6 country treatments x 10 outcomes
*   part3_calibration_log.txt   -- Cost calibration from Table 4
*   part4_gradient_log.txt      -- Sensitivity to fixed cost share
*
...
* Results summary: testing/full_analysis_case/results_note.md
********************************************************************************
...
display as result "  Running all four parts..."
display as result "{hline 72}"

display _newline(2) as result ">>> Part 1: One treatment x 10 outcomes"
do "`casedir'/analysis_part1_outcomes.do"

display _newline(2) as result ">>> Part 2: 6 country treatments x 10 outcomes"
...
display as result "  All four parts completed."
display as result "{hline 72}"
...
display as text "  part1_outcomes_log.txt"
