...
remotes::install_github("OWNER/mhtopt", subdir = "r/mhtopt")
```
...
Open a [GitHub issue](https://github.com/OWNER/mhtopt/issues) and indicate `packageVersion("mhtopt")` and `R.version.string`.
